...
export default function PricingSection() {
    ...
    /* Left Decorative Pattern */
          ...
          <div className="w-12 self-stretch relative overflow-hidden hidden md:block">
            <div className="w-[162px] left-[-58px] top-[-120px] absolute flex flex-col justify-start items-start">
              {Array.from({ length: 200 }).map((_, i) => <div
    key={i}
  ...
  >
    ...
    "Standard templates",
    "Basic analytics"
  ].map((feature, index) => <div key={index} className="self-stretch flex justify-start items-center gap-[13px]">
  ...
  >
    ...
    /* CTA Button */
                ...
                <div className="self-stretch px-4 py-[10px] relative bg-[#FBFAF9] shadow-[0px_2px_4px_rgba(55,50,47,0.12)] overflow-hidden rounded-[99px] flex justify-center items-center">
                  <div className="w-full h-[41px] absolute left-0 top-[-0.5px] bg-gradient-to-b from-[rgba(255,255,255,0)] to-[rgba(0,0,0,0.10)] mix-blend-multiply" />
