...
export function DashboardPreview() {
  return <section className="relative pb-16">
      ...
      <div className="relative bg-white rounded-lg shadow-lg border border-[#e0dedb] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-4 border-b border-[#e0dedb]">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-[#37322f] rounded-full" />
          </div>
        </div>
        ...
        <div className="flex">
          ...
          <div className="w-48 bg-[#fbfaf9] border-r border-[#e0dedb] p-4">
            <nav className="space-y-2">
              ...
              {["Home", "Customers", "Billing", "Schedules", "Invoices", "Products"].map((item) => <div key={item} className="text-sm text-[#37322f] py-1 hover:text-[#37322f]/80 cursor-pointer">
                {item}
              </div>)}
            </nav>
          </div>
          ...
          <div className="flex-1 p-6">
            ...
            <div className="bg-white border border-[#e0dedb] rounded-lg overflow-hidden">
              ...
              {Array.from({ length: 8 }).map((_, i) => <div key={i} className="grid grid-cols-6 gap-4 p-4 border-b border-[#e0dedb] text-sm">
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 bg-[#37322f] rounded-full" />
                  <span>Hypernise</span>
                </div>
                <div>
                  <span
                    className={`px-2 py-1 rounded text-xs ${i % 3 === 0 ? "bg-green-100 text-green-700" : i % 3 === 1 ? "bg-blue-100 text-blue-700" : "bg-gray-100 text-gray-700"}`}
                  >
                ...
                <div className="text-[#605a57]">1 Aug 2025</div>
                <div className="text-[#605a57]">10 Jun 2025</div>
              </div>)}
            </div>
          </div>
        </div>
